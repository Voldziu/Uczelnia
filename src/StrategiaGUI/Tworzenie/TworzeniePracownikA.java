...
public class TworzeniePracownikA implements Tworzenie{
    @Override
    public void Stworz(GUI g) {
        ArrayList<String> nazwy = new ArrayList<>(Arrays.asList("ID", "Imie", "Nazwisko", "Pesel", "wiek","plec","stanowisko","stazPracy","pensja","Liczba Nadgodzin"));
        String napis = "Pracownika Administracji";
        ...
        g.setZatwierdzStworzA(new JButton("Zatwierdz"));
        g.setWyjdzStworz(new JButton("Wyjdz"));
        g.getZatwierdzStworzA().addActionListener(g);
        ...
        g.getCentrumNaglowek().add(g.getZatwierdzStworzA());
